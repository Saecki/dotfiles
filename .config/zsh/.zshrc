...
alias cdnd='cd ~/.local/share/nvim'
alias cdnp='cd ~/.local/share/nvim/site/pack/plugs/opt'
...
alias cdtc='cd ~/Projects/typst/package-check'
...
alias cftm='(cd ~/.config/tmux && $EDITOR ~/.config/tmux/tmux.conf)'
